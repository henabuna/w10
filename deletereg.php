  ...
  <div class="row">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form name="deleteform" method="post" action="deletereg.php"  onSubmit="return validate()" class="form-horizontal" role="form">
	...
	if(isset($_POST["submit"]))
		{
			...
			if (!$connection)
				...
				$q='SELECT UserName FROM reglogin WHERE UserName = "'.$_POST["name"].'" && Password="'.$_POST["Password"].'"';
				...
				{
				$q='DELETE FROM reglogin WHERE UserName = "'.$_POST["name"].'" && Password="'.$_POST["Password"].'"';
