...
<CENTER><ul>
			  ...
			  <li class="level1 item383"><a href="#" class="level1"><span>View</span></a><div class="dropdown columns1"><div class="dropdown-bg"><div><div class="width100 column"><ul class="level2"><li class="level2 item198"><a href="../instructorpage.php" class="level2"><span>schedule</span></a></li><li class="level2 item198"><a href="../viewappeal.php" class="level2"><span>Appeal</span></a></li>
			...
			<li class="level1 item383"><a href="#" class="level1"><span>Upload</span></a><div class="dropdown columns1"><div class="dropdown-bg"><div><div class="width100 column"><ul class="level2"><li class="level2 item198"><a href="Upload.php" class="level2"><span>File</span></a></li>
			  </li><li class="level1 item196 parent active current"><a href="Uploadreg.php" class="level1 parent active current"><span>Grade</span></a>
			</ul></div></div></div></div></li>
...
<left>
<div id="content" height="173">
<form action="UploadProcess1.php" method="post" enctype="multipart/form-data">
