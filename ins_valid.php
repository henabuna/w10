...
$login=mysql_query("SELECT UserName,Password
   FROM instructorlogin where UserName='$UserName' and Password='$Password'");
$num_row=mysql_num_rows($login);
$row=mysql_fetch_array($login);
if($num_row==1){
header('location:post/inindex.php');}
...
echo "<script>window.location='instructorlogin.php';</script>";
