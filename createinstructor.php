...
$query="INSERT INTO instructorlogin (UserName,department,degree,age,Password,ConfirmPassword)
  ...
  <div class="row">
      <div class="panel panel-default">
        <div class="page-header">
          <h1 style = "margin-left:50px;">Create <small>Account For Instructor</small></h1>
        </div>
        <div class="panel-body">
          <form name="loginform" method="post" action="createinstructor.php"  onSubmit="return validate()" class="form-horizontal" role="form">
