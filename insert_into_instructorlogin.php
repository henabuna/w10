...
mysql_select_db("sims",$connection);
 ...
 $sql="INSERT INTO instructorlogin (UserName,Password,ConfirmPassword)
 ...
 echo "<br>";
 echo "<a href='depheadpage.html'>Back to main page</a>";
 */
...
echo '<tr bgcolor="#0099FF" >';
 echo '<th colspan="3" valign="top">';
  echo "<br>";
   echo "<br>";
echo "<a href='depheadpage.html'> <STRONG>GO BACK TO PAGE</STRONG></a>";
 echo "<br>";
 echo "<br>";
 echo '</th>';
