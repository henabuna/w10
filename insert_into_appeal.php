...
mysql_select_db("sims",$connection);
 ...
 $sql="INSERT INTO appeal (id,instructor,appeal)
 VALUES ('$_POST[id]','$_POST[instructor]','$_POST[appeal]')";
...
echo '<tr bgcolor="#0099FF" >';
 echo '<th colspan="3" valign="top">';
  echo "<br>";
   echo "<br>";
echo "<a href='studentpage.html'> <STRONG>GO BACK TO PAGE</STRONG></a>";
 echo "<br>";
 echo "<br>";
 echo '</th>';
