...
<li class="level1 item383"><a href="depindex.php" class="level1"><span>Information</span></a></li>
...
<li class="level1 item383"><a href="../adds.php" class="level1"><span>Add Schedule</span></a></li>
			<li class="level1 item383"><a href="../depheadlogin.php" class="level1"><span>LogOut</span></a></li>
...
<div id="container">
        ...
        <form action="depinsert.php" method="post">
        	Subject: </br>
            <input type="text" name="subject" style="width:500px;"></br></br>
           	<textarea name="body" id="body" style="width:820px; height:300px; background-color:#FFF;"></textarea>
